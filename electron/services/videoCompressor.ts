    ...
    async compress(
        ...
        return new Promise((resolve, reject) => {
            ...
            if (options.encoder === 'libx264') {
                ...
                command.addOutputOption('-x264-params', 'keyint=300:min-keyint=1:ref=4:bframes=3:b-adapt=2:me=umh:merange=24:subme=10:trellis=2:direct=auto:scenecut=60:qcomp=0.5:psy-rd=0.3:0:aq-mode=2:aq-strength=0.8:deblock=1:1:rc-lookahead=60');
            }
