...
import type { VideoInfo, DownloadProgress, DownloadStatus, DownloadError } from '../services/download/types';
import {
    parseVideoUrl,
    startDownload,
    cancelDownload,
...
export function useDownload(): UseDownloadReturn {
    ...
    const download = useCallback(async (formatId: string): Promise<string | undefined> => {
