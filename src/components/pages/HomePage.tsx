            ...
            <div className="max-w-7xl mx-auto w-full flex-1 flex flex-col">
                ...
                <main className="flex-1 flex flex-col items-center justify-center max-w-4xl mx-auto w-full">
                    ...
                    <div className="w-full mb-10">
                        ...
                        <p className="text-center text-slate-500 text-sm mt-4">支持视频下载、字幕生成、翻译润色、压制导出全流程</p>
                    </div>
                    ...
                    <div className="w-full mb-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <button onClick={onStartNew} className="group relative bg-slate-900 border border-slate-800 hover:border-indigo-500/50 hover:bg-slate-800/50 rounded-2xl p-5 transition-all duration-300 flex items-center gap-4 text-left">
                            ...
                            <button onClick={onStartImport} className="group relative bg-slate-900 border border-slate-800 hover:border-emerald-500/50 hover:bg-slate-800/50 rounded-2xl p-5 transition-all duration-300 flex items-center gap-4 text-left">
                    ...
                    <div className="w-full">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            >
                                <div className={`w-12 h-12 bg-slate-800 rounded-xl flex items-center justify-center shrink-0 transition-colors
                                    ${isElectron ? 'group-hover:bg-violet-500/20' : ''}`}>
                                    <Download className={`w-6 h-6 text-violet-400 ${isElectron ? 'group-hover:scale-110' : ''} transition-transform`} />
                                </div>
                                <div>
                            ...
                            >
                                <div className={`w-12 h-12 bg-slate-800 rounded-xl flex items-center justify-center shrink-0 transition-colors
                                    ...
                                    <Scissors className={`w-6 h-6 text-amber-400 ${isElectron ? 'group-hover:scale-110' : ''} transition-transform`} />
                                </div>
                                <div>
