...
export function QualitySelector({ formats, selectedFormat, onSelect, disabled }: QualitySelectorProps) {
                ...
                {formats.map((format) => (
                    <label
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg cursor-pointer transition-colors
                            border ${selectedFormat === format.formatId
                    ...
                    >
                        ...
                        />
                        <span className={`text-sm ${selectedFormat === format.formatId ? 'text-violet-400' : 'text-white/80'}`}>
                            {format.quality}
                            {format.filesize && (
