...
# Walkthrough - Release Update

## Changes

### 1. Glossary Management
- **Import/Export**: Added functionality to import and export glossaries as JSON files.
- **Retry Logic**: Enhanced glossary extraction with robust retry mechanisms.

### 2. Performance
- **VAD Worker**: Moved Voice Activity Detection to a web worker to prevent main thread blocking.
